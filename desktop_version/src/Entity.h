...
public:
    ...
    void createblockoffset(int rxoff, int ryoff, int t, int xp, int yp, int w, int h, int trig = 0, const std::string& script = "", bool custom = false);
    ...
    void createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1, int meta2,
        int p1, int p2, int p3, int p4);
    void createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1, int meta2,
        int p1, int p2);
    void createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1, int meta2,
        int p1);
    void createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1, int meta2);
    void createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1);
    void createentityoffset(int rxoff, int ryoff, int xp, int yp, int t);
