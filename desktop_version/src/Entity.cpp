...
void entityclass::createblockoffset(int rxoff, int ryoff, int t, int xp, int yp, int w, int h, int trig /*= 0*/, const std::string& script /*= ""*/, bool custom /*= false*/)
{
    xp += rxoff * 320;
    yp += ryoff * 320;
    createblock(t, xp, yp, w, h, trig, script, custom);
}
...
void entityclass::createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1, int meta2, int p1, int p2, int p3, int p4)
{
    xp += rxoff * 320;
    p1 += rxoff * 320;
    p3 += rxoff * 320;
    ...
    p2 += ryoff * 240;
    p4 += ryoff * 240;
    if ((t != 1 && t != 12 && !map.warpx && !map.warpy) || (rxoff == 0 && ryoff == 0)) {
        createentity(xp, yp, t, meta1, meta2, p1, p2, p3, p4);
    }
}
...
void entityclass::createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1, int meta2, int p1, int p2)
{
    createentityoffset(rxoff, ryoff, xp, yp, t, meta1, meta2, p1, p2, 320, 240);
}

void entityclass::createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1, int meta2, int p1)
{
    createentityoffset(rxoff, ryoff, xp, yp, t, meta1, meta2, p1, 0);
}

void entityclass::createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1, int meta2)
{
    createentityoffset(rxoff, ryoff, xp, yp, t, meta1, meta2, 0);
}

void entityclass::createentityoffset(int rxoff, int ryoff, int xp, int yp, int t, int meta1)
{
    createentityoffset(rxoff, ryoff, xp, yp, t, meta1, 0);
}

void entityclass::createentityoffset(int rxoff, int ryoff, int xp, int yp, int t)
{
    createentityoffset(rxoff, ryoff, xp, yp, t, 0);
}
