...
namespace Solver {
    ...
    namespace LAB {
        namespace CORNERS {
            ...
            namespace YOUNG_MAN_ITS_WORTH_THE_CHALLENGE_ENTER {
                ...
                const RawCorner D(rx, ry, 190, 65, DOWN_LEFT);
            ...
            namespace YOUNG_MAN_ITS_WORTH_THE_CHALLENGE_LEAVE {
                ...
                const RawCorner E(rx, ry, 50, 46, UP_RIGHT);
        ...
        namespace SCENARIOS {
            ...
            const RawScenario YOUNG_MAN_ITS_WORTH_THE_CHALLENGE_LEAVE(102, 118, 50, 26, 0, 4, {
                CORNERS::YOUNG_MAN_ITS_WORTH_THE_CHALLENGE_ENTER::E,
                CORNERS::YOUNG_MAN_ITS_WORTH_THE_CHALLENGE_ENTER::F,
                CORNERS::YOUNG_MAN_ITS_WORTH_THE_CHALLENGE_ENTER::TRINKET,
                CORNERS::YOUNG_MAN_ITS_WORTH_THE_CHALLENGE_LEAVE::F,
    ...
    static RawScenario scenario = LAB::SCENARIOS::YOUNG_MAN_ITS_WORTH_THE_CHALLENGE_LEAVE;
    ...
    bool passed_next_corner(int next_corner, int room_x, int room_y, int player_x, int player_y) {
        ...
        RawCorner c = scenario.corners[next_corner];
    ...
    uint16_t get_heuristic(int next_corner_orig, int room_x, int room_y, int player_x, int player_y, int gravity, float vx, float vy, int tapleft, int tapright) {
        ...
        while (next_corner < scenario.corners.size()) {
            ...
            // Skip this corner if we may no longer be before it
            {
                ...
                CornerDir inside_fix_dir = c_dir;
                switch (c_dir) {
                case UP_LEFT:
                    if (x_d <= 0) {
